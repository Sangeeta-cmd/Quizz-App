...
MCQ[1] = {
    ...
    currOpt :'Both the <head> section and the <body> section are correct',
}
...
MCQ[4] = {
    question:'5.Which of the folowing function is used to perform asynchronous calls?',
    option1 :'Split()',
    option2 :'setTimeout()',
    option3 :'settimeout()',
    option4 :'Promises',
